      ...
      <section id="projects" className="container w-full mx-auto my-12 sm:my-16 lg:my-24 xl:my-32 max-w-7xl px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
        <div className="bg-[#111111] rounded-2xl w-full max-w-6xl shadow-2xl mx-auto p-6 sm:p-8 lg:p-12 xl:p-16 my-8 lg:my-12">
          <div className="flex w-auto h-auto justify-between mx-auto mb-6 lg:mb-8">
            <div>
              <h2 className="text-[#fafafa] font-inter text-3xl sm:text-4xl lg:text-4xl xl:text-5xl font-bold mb-3 sm:mb-4 lg:mb-6">
                Projects
              </h2>
          ...
          <div className='w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8 xl:gap-10 mt-8 lg:mt-12'>
            <article className="flex flex-col w-full bg-[#424242] rounded-2xl shadow-2xl p-6 lg:p-8 hover:bg-[#4a4a4a] transition-all duration-300 hover:scale-105 hover:shadow-3xl">
              <div className="flex-1">
                <time className="text-sm lg:text-base text-[#FDD26A] font-bold mb-2 lg:mb-3">2023</time>
              ...
              <div className="flex justify-end">
                <a 
                  ...
                  className="flex border-2 w-12 h-12 lg:w-14 lg:h-14 rounded-xl justify-center items-center border-[#fdd26a] hover:bg-[#fdd26a] hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group"
                  aria-label="View ClueNet project on GitHub"
                >
                  <svg
            ...
            <article className="flex flex-col w-full bg-[#424242] rounded-2xl shadow-2xl p-6 lg:p-8 hover:bg-[#4a4a4a] transition-all duration-300 hover:scale-105 hover:shadow-3xl">
              <div className="flex-1">
                <time className="text-sm lg:text-base text-[#FDD26A] font-bold mb-2 lg:mb-3">2021</time>
                <h3 className="font-inter font-bold text-[#ffffff] text-lg lg:text-xl xl:text-2xl mb-3 lg:mb-4 leading-tight">
              ...
              <div className="flex justify-end">
                <a 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  href="https://github.com/KevinGeejo/Railway-Ticket-Booking-System-JavaFx-main" 
                  className="flex border-2 w-12 h-12 lg:w-14 lg:h-14 rounded-xl justify-center items-center border-[#fdd26a] hover:bg-[#fdd26a] hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group"
                  aria-label="View Railway Ticket Booking System project on GitHub"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
            ...
            <article className="flex flex-col w-full bg-[#424242] rounded-2xl shadow-2xl p-6 lg:p-8 hover:bg-[#4a4a4a] transition-all duration-300 hover:scale-105 hover:shadow-3xl md:col-span-2 xl:col-span-1">
              <div className="flex-1">
                <time className="text-sm lg:text-base text-[#FDD26A] font-bold mb-2 lg:mb-3">2024</time>
                <h3 className="font-inter font-bold text-[#ffffff] text-lg lg:text-xl xl:text-2xl mb-3 lg:mb-4 leading-tight">
              ...
              <div className="flex justify-end">
                <a 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  href="https://github.com/KevinGeejo/Blockchain_Voting_System" 
                  className="flex border-2 w-12 h-12 lg:w-14 lg:h-14 rounded-xl justify-center items-center border-[#fdd26a] hover:bg-[#fdd26a] hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group"
                  aria-label="View Blockchain Voting System project on GitHub"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
