...
const Hero = () => {
  return (
    ...
    <div id="hero" className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 min-h-[600px] lg:min-h-[700px] py-8 sm:py-12 lg:py-20 pt-32 sm:pt-36 lg:pt-40">
      ...
      smooth={true} 
      offset={-40} 
      duration={500}  className="bg-[#fdd26a] hover:bg-transparent hover:text-[#fdd26a] hover:border-2 hover:border-[#fdd26a] text-black font-bold py-4 px-8 lg:py-4 lg:px-10 rounded-xl transition-all duration-300 cursor-pointer text-lg lg:text-lg shadow-lg hover:shadow-2xl">
            About Me
          </Link>
        </div>
