        ...
        <div className="container mx-auto max-w-6xl px-8   justify-center">
            <div className="bg-[#171717] text-white py-20 flex justify-left items-left mt-[12%] justify-center flex-col">
                <div className="flex flex-col items-center text-left py-auto justify-center"> {/* Modified className */}
                    ...
                    <Typed className="text-[#fafafa] text-center content-center text-5xl mb-4  font-extrabold" strings={['Hi!', "I'm Kevin Geejo."]} typeSpeed={60} backSpeed={60} loop loopCount={2}></Typed>
                    ...
                    <p  className="text-[#fafafa] mx-14 mb-14 mt-4 text-[20px] hover:text-[#fdd26a]  text-center font-inter font-medium justify-self-center">A fullstack developer from Mumbai, India.</p>
